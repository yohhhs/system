<template>
    <div class="login">
        ...
        <div class="vali" v-if="errNum">
            ...
            <img class="vali-img" src="//fakeimg.pl/80x36">
        </div>
        ...
        <div class="footer">
            <span @mouseover="isLeft" @click='loginToForget'>忘记密码</span>
            <span class="right" @mouseover="isRight" @click='loginToRegister'>立即注册</span>
        </div>
    </div>
</template>
<script>
