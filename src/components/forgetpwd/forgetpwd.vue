<template>
    <div class="forgetpwd">
        ...
        <Input class="input" @on-enter="userLogin" v-model="pwd" type="password" size="large" placeholder="请输入新密码"></Input>
        <Input class="input" @on-enter="userLogin" v-model="pwd" type="password" size="large" placeholder="请再次输入新密码"></Input>
